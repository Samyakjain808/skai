  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-8 bg-gradient-to-br from-cyan-200 to-cyan-500 py-4 bg-clip-text text-center text-4xl font-bold tracking-tight text-transparent md:text-7xl"
      >
        Skelix
      </motion.h1>
      <motion.p
        ...
        className="mt-4 text-center text-xl md:text-2xl text-white/80"
      >
        Plug Into the Power of Unified AI
      </motion.p>
    </LampContainer>
  );
}
...
export function LampContainer({ children, className }) {
  return (
    <div
    className={cn(
      "relative flex min-h-screen flex-col items-center justify-center overflow-hidden w-full z-0 bg-transparent",
      className
    )}
  >
      ...
      <div id="stars2" className="absolute inset-0 z-0" />
      <div id="stars3" className="absolute inset-0 z-0" />
